...
def get_params():
    params = {
        'weight': '../ultralytics-main/runs/train/exp33/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        ...
        'task':'obb', # 任务(detect,segment,pose,obb,classify)
        'img_size':640, # 图像尺寸
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'D:\pycharm\ultralytics-main (2)\ultralytics-main\ultralytics\images\xray_hard02907.png', 'result')
